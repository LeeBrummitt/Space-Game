...
for(var i = firstPoint, j = 0; i < min(ds_grid_width(instance_find(player, 0).inventory), lastPoint); i++){
	if(ds_grid_get(instance_find(player, 0).inventory, i, 0) != 0){
		if(i == selectedItem){
		...
		draw_text_transformed_color((4/36)*rx, (6/36)*ry+(j+1)*(2/36)*ry, ds_grid_get(instance_find(player, 0).inventory, i, 0), (0.5/1000)*rx, (0.5/1000)*ry, 0, c_black, c_black, c_black, c_black, 1);
		draw_text_transformed_color((13/36)*rx, (6/36)*ry+(j+1)*(2/36)*ry, ds_grid_get(instance_find(player, 0).inventory, i, 1), (0.5/1000)*rx, (0.5/1000)*ry, 0, c_black, c_black, c_black, c_black, 1);
		draw_text_transformed_color((20/36)*rx, (6/36)*ry+(j+1)*(2/36)*ry, ds_grid_get(instance_find(player, 0).inventory, i, 2), (0.5/1000)*rx, (0.5/1000)*ry, 0, c_black, c_black, c_black, c_black, 1);
		draw_text_transformed_color((25/36)*rx, (6/36)*ry+(j+1)*(2/36)*ry, ds_grid_get(instance_find(player, 0).inventory, i, 3), (0.5/1000)*rx, (0.5/1000)*ry, 0, c_black, c_black, c_black, c_black, 1);
		j++;
	}
}