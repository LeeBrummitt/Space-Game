...
draw_text_transformed_color((4/36)*rx, (6/36)*ry, "Character", (0.5/1000)*rx, (0.5/1000)*ry, 0, c_black, c_black, c_black, c_black, 1);

//TODO: Use multiple pages for long inventories
//TODO: Limit size of item names, etc

for(var i = firstPoint, j = 0; i < min(array_length_1d(characters)-1, lastPoint); i++){
	if(characters[i] != ""){
		if(i == selectedItem){
		...
		draw_text_transformed_color((4/36)*rx, (6/36)*ry+(j+1)*(2/36)*ry, characters[i], (0.5/1000)*rx, (0.5/1000)*ry, 0, c_black, c_black, c_black, c_black, 1);
		j++;
	}
}